...
const BulletinDetailScreen = ({ props, route }) => {
    ...
    const { setIsDeleting, bulletinDetailData, setBulletinDetailData, getBulletinDetailData,
    ...
    useEffect(() => {
        ...
        getBulletinDetailData(route.params.item.id);
        setIsDeleting(false);
        let no = 1;
        const stopYoutube = () => {
    ...
    return (
        loginData.loginStatus === 'login' ? (
            ...
            <>
                ...
                {bulletinDetailData !== null ?
                    (
                        <>
                            {/* <HeaderBar title={bulletinDetailData.type == 'bulletin'?'Bulletin Details':'News Details'} headerType="postDetail"
              id={id}  
             postType={bulletinDetailData.type}   icon="document-text-outline" /> */}
 {
                                    isLoadingPost === true ?
                                        (
                                            <Spinner size={60} />) :
                                ...
                                <View style={[styles.content, {
                                    ...
                                    <View style={{ flex: 1, flexDirection: 'row', }}>
                                            <Image style={[styles.image, { flex: 1, height: 100, borderRadius: 2, marginRight: 5 }]}
                                                source={{ uri: GLOBAL.BASE_URL + `web/media/xs/` + bulletinDetailData.image }} />
                                            <Text style={[styles.postTitle, { flex: 3, fontWeight: 'bold' }]}>{bulletinDetailData.title}</Text>
                                        </View>
                                        ...
                                        <View style={{
                                            ...
                                            <Text style={[styles.postTitle, { flex: 3 }]}>{bulletinDetailData.subtitle}</Text>
                                            <Text style={{ fontWeight: 'bold' }}>DATE: {bulletinDetailData.created_at}</Text>
                                      ...
                                      <FlatList
                                        ...
                                        <HtmlReader html={bulletinDetailData.body} youtube={youtube ? youtube : null} />
