...
import {
    ...
    ScrollView, ActivityIndicator, TouchableOpacity, useWindowDimensions, Linking, ImageBackground
} from 'react-native'
             ...
             postType={postDetailData.type}   icon="document-text-outline" /> */}
 {
                            ...
                            <Header
                                ...
                                centerComponent={<ScreenTitle icon='document-text-outline'
                                    title={screenTitle} />}
                                rightComponent={<DeleteButton id={id} postType='post' />}
                                ...
                                <View style={[styles.content, {
                                    ...
                                    <ScrollView style={{ flex: 1, paddingRight: 10 }}>
                                        ...
                                        <View style={{ flex: 1, flexDirection: 'row', }}>
                                            ...
                                            <Text style={[styles.postTitle, { flex: 3 }]}>{postDetailData.title}</Text>
                                        </View>
